...
const Hero = () => {
    return (
        <div className="h-[200vh] mt-32 dark-light-text "> {/* bu uzun kontent scroll qilish uchun */}
            <h1 className="text-6xl font-mono text-black" data-aos="fade-up" data-aos-delay="200">Assalomu, Alaykum</h1>
